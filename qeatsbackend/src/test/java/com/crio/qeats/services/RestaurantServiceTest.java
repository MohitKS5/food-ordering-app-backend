...
class RestaurantServiceTest {
  ...
  private String getServingRadius(List<Restaurant> restaurants, LocalTime timeOfService) {
    ...
    for (int i = 0; i < restaurants.size(); i++) {
      assertEquals(restaurants.get(i).getRestaurantId(),
          allRestaurantsCloseBy.getRestaurants().get(i).getRestaurantId());
    }
  ...
  void normalHourServingRadiusIs5Kms() throws IOException {
    assertEquals(getServingRadius(loadRestaurantsDuringNormalHours(), LocalTime.of(18, 0)), "5.0");
